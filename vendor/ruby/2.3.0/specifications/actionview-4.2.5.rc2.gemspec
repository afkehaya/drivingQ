# -*- encoding: utf-8 -*-
# stub: actionview 4.2.5.rc2 ruby lib
...
Gem::Specification.new do |s|
  ...
  if s.respond_to? :specification_version then
    ...
    if Gem::Version.new(Gem::VERSION) >= Gem::Version.new('1.2.0') then
      ...
      s.add_development_dependency(%q<actionpack>.freeze, ["= 4.2.5.rc2"])
      s.add_development_dependency(%q<activemodel>.freeze, ["= 4.2.5.rc2"])
    else
